...
<body class="navbar-fixed-top-padding cbp-spmenu-push">
	...
	<div class="container">
	    <div class="zsk-marks-container">
	        <div class="textlink-bar page-header clearfix" id="player-nav">
	            
	        </div>
	    </div>
	    <div class="container-fluid prod-box wj-list-box">
	...
	{{ mgmb.scripts(config,[
        ...
        ,"gmpro/1.0.0/gmbuy/1.0.0/js/dropload.min.js",
        ,"gmpro/1.0.0/gmbuy/1.0.0/templatefn/tpl-wj.min.js"
        ,"gmpro/1.0.0/gmbuy/1.0.0/js/wj.min.js"
	]) }}
