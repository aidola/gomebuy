...
{% macro normalHead(config,title) %}
	...
	<link rel="stylesheet" href="{{ config.domain }}/bootstrap.css">
	<link rel="stylesheet" href="{{ config.domain }}/css.css">
	<!-- IE9以下对HTML5标签的支持做兼容 -->
	<!-- respond.js解决IE6-8不支持响应式布局media query -->
	<!--[if lt IE 9]>

	<script src="{{ config.domain }}/respond.min.js"></script>
	<script src="{{ config.domain }}/modernizr.min.js"></script>
	<![endif]-->
{% endmacro %}
